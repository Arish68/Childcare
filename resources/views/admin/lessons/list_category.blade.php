            ...
            <div class="card-body">
                ...
                <table id="example1" class="table table-striped" style="width: auto;">
                    ...
                    <tr>
                        ...
                        <th  style="width: 15%;">Decription</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                                ...
                                <form id="delete-form-{{$li->id}}" action="{{route('delete-category',$li->id)}}" method="post" style="display:none">
                                  {{csrf_field()}}
                                  {{method_field('DELETE')}}
                                </form>
                                ...
                                <td>
                                   ...
                                   <a href="{{route('edit-category',$li->id)}}" id="colors">Edit /</a>
