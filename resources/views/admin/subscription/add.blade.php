     ...
     <div class="row">
     	...
     	<div class="col-lg-5">
	       ...
	       <div class="card">
	                    ...
	                    <div class="card-body">
	                        <h5 class="card-title"><strong>Add Subscription Plan</strong></h5>
							<form action="{{route('add-subPlan')}}" method="post" enctype="multipart/form-data">
								{{csrf_field()}}
                                ...
                                <input type="text" class="form-control" placeholder="Sub Title" name ="sub_title" required value="{{old('sub_title')}}">
								</div>
								<div class="form-group">
                                 ...
                                 <div class="form-group">
	                              <label>Amount</label>
                                <input type="text" class="form-control" placeholder="Amount" name ="amount" required value="{{old('amount')}}">
								</div>      
								 <div class="form-group">
					           ...
					           <div class="form-group">
                                ...
                                <input type="number" class="form-control" placeholder="sort_order" name ="sort_order" required value="{{old('sort_order')}}">
								</div>
